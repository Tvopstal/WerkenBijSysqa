...
class SysqaDienstenGUI (CommonTestCase):

    """"Tests voor de Sysqa Over pagina"""

    def test_sysqa_diensten (self):


        self.testcase = "TC_SysqaDienstenGUI"
...
if __name__ == "__main__":
    if len(sys.argv) >1:
        SysqaDienstenGUI.pipeline = sys.argv.pop()
    unittest.main()
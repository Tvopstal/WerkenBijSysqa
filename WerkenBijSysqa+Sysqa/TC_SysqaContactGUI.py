...
class SysqaContactGUI (CommonTestCase):

    """"Tests voor de Sysqa Contact pagina"""

    def test_sysqa_contact (self):


        self.testcase = "TC_SysqaContactGUI"
...
if __name__ == "__main__":
    if len(sys.argv) >1:
        SysqaContactGUI.pipeline = sys.argv.pop()
    unittest.main()